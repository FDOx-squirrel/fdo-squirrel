...
| Reihenfolge: Release (S10) vs. `fdo-3d-packager`-Pin-Bump | Erst `fdo-3d-packager` in einem eigenen Chat auf `fdo-squirrel`-HEAD (`2b1a440`, Stand nach S17) pinnen und frisch durchlaufen lassen, danach — wenn das passt — hier S10 (Release). Flos Entscheidung, verhindert einen Release, der noch nicht Ende-zu-Ende gegen den Packager getestet ist | 2026-09-09 |
